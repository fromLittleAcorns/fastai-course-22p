...
d = { 'settings': { 'branch': 'master',
                'doc_baseurl': '/fastai-course-22p',
                'doc_host': 'https://fastai.github.io',
                'git_url': 'https://github.com/fastai/fastai-course-22p',
                'lib_path': 'miniai'},
  'syms': { 'miniai.activations': { 'miniai.activations.ActivationStatsCB': ('activations.html#activationstatscb', 'miniai/activations.py'),
            ...
            'miniai.core': {'miniai.core.foo': ('old_core.html#foo', 'miniai/core.py')},
            'miniai.datasets': { 'miniai.datasets.collate_dict': ('datasets_and_plotting.html#collate_dict', 'miniai/datasets.py'),
                                 'miniai.datasets.get_grid': ('datasets_and_plotting.html#get_grid', 'miniai/datasets.py'),
                                 'miniai.datasets.inplace': ('datasets_and_plotting.html#inplace', 'miniai/datasets.py'),
                                 'miniai.datasets.show_image': ('datasets_and_plotting.html#show_image', 'miniai/datasets.py'),
                                 'miniai.datasets.show_images': ('datasets_and_plotting.html#show_images', 'miniai/datasets.py'),
                                 'miniai.datasets.subplots': ('datasets_and_plotting.html#subplots', 'miniai/datasets.py')},
            ...
            'miniai.learner': { 'miniai.learner.Callback': ('learner.html#callback', 'miniai/learner.py'),
                                ...
                                'miniai.learner._CbCtxInner': ('learner.html#_cbctxinner', 'miniai/learner.py'),
                                'miniai.learner._CbCtxInner.__enter__': ('learner.html#_cbctxinner.__enter__', 'miniai/learner.py'),
                                'miniai.learner._CbCtxInner.__exit__': ('learner.html#_cbctxinner.__exit__', 'miniai/learner.py'),
                                'miniai.learner._CbCtxInner.__init__': ('learner.html#_cbctxinner.__init__', 'miniai/learner.py'),
            ...
            'miniai.resnet': { 'miniai.resnet.ResBlock': ('resnet-copy1.html#resblock', 'miniai/resnet.py'),
                               'miniai.resnet.ResBlock.__init__': ('resnet-copy1.html#resblock.__init__', 'miniai/resnet.py'),
                               'miniai.resnet.ResBlock.forward': ('resnet-copy1.html#resblock.forward', 'miniai/resnet.py'),
                               'miniai.resnet._conv_block': ('resnet-copy1.html#_conv_block', 'miniai/resnet.py')},
            ...
            'miniai.training': { 'miniai.training.Dataset': ('dataloaders_optimisers_training.html#dataset', 'miniai/training.py'),
                                 'miniai.training.Dataset.__getitem__': ( 'dataloaders_optimisers_training.html#dataset.__getitem__',
                                                                          'miniai/training.py'),
                                 'miniai.training.Dataset.__init__': ( 'dataloaders_optimisers_training.html#dataset.__init__',
                                                                       'miniai/training.py'),
                                 'miniai.training.Dataset.__len__': ( 'dataloaders_optimisers_training.html#dataset.__len__',
                                                                      'miniai/training.py'),
                                 'miniai.training.accuracy': ('dataloaders_optimisers_training.html#accuracy', 'miniai/training.py'),
                                 'miniai.training.fit': ('dataloaders_optimisers_training.html#fit', 'miniai/training.py'),
                                 'miniai.training.get_dls': ('dataloaders_optimisers_training.html#get_dls', 'miniai/training.py')}}}
